...
from binaryninja import Architecture, RegisterName, RegisterInfo, InstructionInfo
...
class ExampleArchitecture(Architecture):
    ...
    def get_instruction_text(self, data: bytes, addr: int) -> Optional[Tuple[List, int]]:
        ...
        if opcode == 0x90:  # NOP
            ...
            tokens.append(InstructionTextToken(
                InstructionTextTokenType.InstructionToken, "ret"
            ))
        else:
            tokens.append(InstructionTextToken(
